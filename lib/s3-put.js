...
function PutS3(options){
    ...
    this.putObject = function putObject(obj, cntxt, credz, cb, ...rest){
        ...
        if (debug){
            ...
            console.log('putObject():: Context = Function | ' + cntxt.name);
            console.log('putObject():: Credz = Object | ' + JSON.stringify(credz, null, 2));
            console.log('putObject():: Callback = Function | ' + cb.name);
